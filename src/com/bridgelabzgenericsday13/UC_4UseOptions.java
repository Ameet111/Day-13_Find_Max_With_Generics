...
public class UC_4UseOptions  <T extends Comparable<T>>  {
	T first;
	T second;
	T third;
	public UC_4UseOptions(T x, T y, T z) {
		this.first = x;
		this.second = y;
		this.third = z;
	}
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
			{
				...
				System.out.println("Maximum  is : " + new UC_4UseOptions(first, second, third).maximum());
